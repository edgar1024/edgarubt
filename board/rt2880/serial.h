...
#define RT2880_UART_HIGHSPEED_OFFSET	0x24
#define RT2880_UART_SAMPLE_COUNT_OFFSET 0x28
#define RT2880_UART_SAMPLE_POINT_OFFSET 0x2C
#else
#define RT2880_UART_RBR_OFFSET	0x00
...
#define HIGHSPEED(x) __REG(RALINK_SYSCTL_BASE + (x) + RT2880_UART_HIGHSPEED_OFFSET)
#define SAMPLE_COUNT(x) __REG(RALINK_SYSCTL_BASE + (x) + RT2880_UART_SAMPLE_COUNT_OFFSET)
#define SAMPLE_POINT(x) __REG(RALINK_SYSCTL_BASE + (x) + RT2880_UART_SAMPLE_POINT_OFFSET)
